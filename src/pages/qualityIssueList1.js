                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell numeric>{n.Customer}</TableCell>
                      <TableCell numeric>{n.Project}</TableCell>
                      <TableCell numeric>{n.PartNumber}</TableCell>
                      <TableCell numeric>{n.ResponsibleDepartment}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
