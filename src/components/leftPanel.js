  ...
  render() {
    ...
    return (
      <MenuList>
        ...
        <MenuItem
          style={
            this.state.clickedItem === "Quality"
              ? { backgroundColor: "#B9CCEC" }
              : {}
          }
          className={classes.menuItem}
        ...
        >
          ...
          <ListItemIcon
            style={
              this.state.isQualityOpen ? { transform: "rotate(90deg)" } : {}
            }
          >
            <NextIcon />
          </ListItemIcon>
        ...
        {this.state.isQualityOpen ? (
          <div>
            <MenuItem
              style={
                this.state.clickedItem === "NewIssueRecord"
                  ? { backgroundColor: "#B9CCEC" }
                  : {}
              }
            ...
            >
              ...
              <ListItemText
                ...
                primary="New Issue Record"
              />
            </MenuItem>
            <MenuItem
              style={
                this.state.clickedItem === "QualityIssueList"
                  ? { backgroundColor: "#B9CCEC" }
                  : {}
              }
              className={classes.nested}
              component={Link}
              to="/quality-issue-list"
              exact
              onClick={this.clickQualityIssueList.bind(this)}
            >
              <ListItemIcon>
                <PlusIcon />
              </ListItemIcon>
        ...
        >
          ...
          <ListItemIcon
            style={
              this.state.isProjectOpen ? { transform: "rotate(90deg)" } : {}
            }
          >
            <NextIcon />
          </ListItemIcon>
